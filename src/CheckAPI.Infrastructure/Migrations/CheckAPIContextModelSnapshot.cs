...
namespace CheckAPI.Infrastructure.Migrations
{
    ...
    partial class CheckAPIContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CheckAPI.Domain.Configuracoes.ConfiguracaoInspecao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("configuracoes_inspecao", (string)null);
                });

            modelBuilder.Entity("CheckAPI.Domain.Configuracoes.Entities.Inspecionavel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UNIQUEIDENTIFIER")
                    ...
                    b.Property<Guid>("IdConfiguracaoInspecao")
                        .HasColumnType("UNIQUEIDENTIFIER")
                        .HasColumnName("id_configuracao_inspecao");

                    b.Property<byte>("TipoPreenchimento")
                    ...
                    b.HasIndex("IdConfiguracaoInspecao");

                    b.ToTable("inspecionaveis", (string)null);
                });
            ...
            modelBuilder.Entity("CheckAPI.Domain.Configuracoes.Entities.Inspecionavel", b =>
                {
                    b.HasOne("CheckAPI.Domain.Configuracoes.ConfiguracaoInspecao", "ConfiguracaoInspecao")
                        .WithMany("Inspecionaveis")
                        .HasForeignKey("IdConfiguracaoInspecao")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ConfiguracaoInspecao");
                });
